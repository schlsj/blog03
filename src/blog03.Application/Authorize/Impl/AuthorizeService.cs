...
namespace blog03.Authorize.Impl
{
    public class AuthorizeService : blog03AppService, IAuthorizeService
    {
            ...
            return await _authorizeCacheService.GetAccessTokenAsync(code, async () =>
             {
                 ...
                 content.Headers.ContentType = new MediaTypeHeaderValue("application/www-form-urlencoded");
                 using var client = _httpClient.CreateClient();
